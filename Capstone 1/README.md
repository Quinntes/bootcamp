...
Report Data Hewan: View all records, search by ID or Name, or see data statistics.

Menambahkan Data Hewan: Add new patient entries.

Mengubah Data Hewan: Edit existing patient records or perform mass diagnosis updates.

Menghapus Data Hewan: Delete specific patient records or clear all data.
